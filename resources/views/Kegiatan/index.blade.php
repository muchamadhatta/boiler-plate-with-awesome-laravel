...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4 ">
        ...
        <div>
            <a href="{{ route('Add Kegiatan') }}" class="btn btn-success">
                    ...
                    <tbody>
                        @foreach ($data as $i => $val)
                            <tr>
                                ...
                                <td class="text-center">{{ $val->kegiatan}}</td>
                                <td class="text-center">{{ $val->aksi}}</td>
                                <td class="text-center">
                                    <a href="{{ route('Edit Kegiatan', $val->id) }}" class="btn btn-primary p-1">
                                        <i class="ri-edit-2-line"></i> Edit
                                    </a>
                                    <form action="{{ route('Hapus Kegiatan', $val->id) }}" method="POST"
