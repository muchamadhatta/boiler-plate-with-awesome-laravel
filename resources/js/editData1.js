 ...
 document.addEventListener('DOMContentLoaded', function() {
    ...
    function createTableRow(index) {
        ...
        let requiredPenulis = document.createElement('span');
        requiredPenulis.textContent = '*';
        requiredPenulis.className = 'position-absolute d-flex align-items-end text-danger';
        requiredPenulis.style.top = '30%';
        requiredPenulis.style.right = '5px';
        ...
        td2.appendChild(requiredPenulis);
        ...
        td3.className = 'p-1 border text-center';
        button.type = 'button';
